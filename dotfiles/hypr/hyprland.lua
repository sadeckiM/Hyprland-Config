...
hl.bind(
    ...
    rofi -dmenu -p clipboard -theme-str 'window {width: 45%;} listview {lines: 10;}' | 
    cliphist decode | 
    wl-copy"]])
)
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("pkill -f -USR1 wallpaper_slideshow.sh"))
...
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd("~/.config/hypr/scripts/touchpad-toggle.sh"))

-- Bluetooth

hl.bind("XF86Bluetooth", hl.dsp.exec_cmd("sh -c 'pkill -x rofi || rofi-bluetooth'"))

-- Notifications

hl.bind(mainMod .. " + N", hl.dsp.exec_cmd("swaync-client -C"))
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("sleep 0.1 && swaync-client -t -sw"))
hl.bind(mainMod .. " + SHIFT + D", hl.dsp.exec_cmd("sleep 0.1 && swaync-client -d -sw"))
...
-- for i = 1, 7 do
-- 	-- tostring(i) zamienia cyfrę bezpiecznie na znak tekstowy
-- 	hl.bind(mainMod .. " + ALT + " .. i, hl.dispatch("movetoworkspacesilent", tostring(i)))
-- end
